...
AS
	...
	SELECT WeName, H.Weapon_Poison, H.WeID, it.ItName, wc.Amt_Changed
	FROM Has as H, Weapon As W, Weapon_Changer as wc, item as it, Inventory as i
	Where W.WeID = H.WeID and H.ChId = @ChID and it.ItId = wc.ItID and
	it.ItID = h.Weapon_Poison
	group by H.WeID, H.Weapon_Poison, W.Base_Damage, WeName, it.ItName, wc.Amt_Changed;
GO